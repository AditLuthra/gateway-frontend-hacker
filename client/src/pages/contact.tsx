...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact MakrX - Get Support, Partner With Us</title>
        <meta 
          name="description" 
          content="Get in touch with MakrX team for support, partnerships, or general inquiries. Multiple offices across India. 24-hour response time guaranteed." 
        />
      </Helmet>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="card-cyberpunk p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label htmlFor="name" className="block text-sm font-semibold text-dark-text-primary mb-2 font-mono">
                        Full Name *
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="email" className="block text-sm font-semibold text-dark-text-primary mb-2 font-mono">
                        Email Address *
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label htmlFor="category" className="block text-sm font-semibold text-dark-text-primary mb-2 font-mono">
                        Category *
                      </label>
                      <select
                        id="category"
                    ...
                    <div>
                      <label htmlFor="priority" className="block text-sm font-semibold text-dark-text-primary mb-2 font-mono">
                        Priority
                      </label>
                      <select
                        id="priority"
                  ...
                  <div className="mb-6">
                    <label htmlFor="subject" className="block text-sm font-semibold text-dark-text-primary mb-2 font-mono">
                      Subject *
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="mb-8">
                    <label htmlFor="message" className="block text-sm font-semibold text-dark-text-primary mb-2 font-mono">
                      Message *
                    </label>
                    <textarea
                      id="message"
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 bg-dark-bg-secondary border border-makr-blue/30 rounded-xl text-dark-text-primary placeholder-dark-text-muted focus:ring-2 focus:ring-makr-yellow/50 focus:border-makr-yellow transition-all resize-none font-mono"
                  ...
                  <button
                    ...
                    className="w-full btn-cyberpunk text-lg py-4 disabled:opacity-50 disabled:cursor-not-allowed font-mono"
                  >
                    {isSubmitting ? (
                      <div className="flex items-center justify-center">
                        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-makr-blue mr-3"></div>
                        Sending Message...
                      </div>
                    ) : (
                      <div className="flex items-center justify-center">
